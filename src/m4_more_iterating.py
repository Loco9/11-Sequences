...
def run_test_count_positive_sines():
    ...
    # Test 11
    expected = 2
    actual = count_positive_sines([5, 1, 10, 8])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 9
    expected = 30
    actual = sum_first_n([-10, 30, 7, 3], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
